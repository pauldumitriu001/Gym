...
export default function Generator(props) {
  ...
  return (
    <SectionWrapper
      id={"generate"}
      header="Generate your poison"
      title={[`It\'s'`, `Huge`, `'o\'clock`]}
    >
      {/** Header 1: Workout plan*/}
      <Header
        index={`01`}
        title={`Pick your Poison`}
        description={`Select the poison you wish to to endure`}
      />
      ...
      {/** Header 2: Muscle groups*/}
      <Header
        index={`02`}
        title={`Lock on target`}
        description={`Select the muscles judged for annihlation`}
      />
      <div className="bg-slate-950 py-3 border border-solid border-blue-400 flex flex-col">
        <button
          onClick={toggleModal}
